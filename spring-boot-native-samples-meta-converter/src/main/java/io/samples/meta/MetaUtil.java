    ...
    private static void handleMetaClass(MetaClass metaClass, Object document) {
        ...
        for(MetaProperty metaProperty: properties) {
            if(metaProperty.getType().equals(MetaClass.class.getName())) {
                ...
                loadClass(typeNameNamespace, typeName);
...
//        }
    ...
    private static MetaClass loadClass(String namespace, String name) {
        ...
        if(name.equals("Store")) {
            ...
            bicycleProperty.setName("bicycle");
            bicycleProperty.setType(MetaClass.class.getName());
            bicycleProperty.setTypeName("Bicycle");
            properties.add(bicycleProperty);

            MetaProperty bookProperty = new MetaProperty();
            bookProperty.setName("book");
            bookProperty.setType(MetaCollection.class.getName());
            bookProperty.setTypeName("Book");
            properties.add(bookProperty);
